  ...
  associacoes: [
    {
      ...
      descricao: 'Principal associação de artesãs da região de Jaguaribe, preservando a tradição da renda de filé há mais de 50 anos.',
      endereco: {
        rua: 'Rua das Flores',
        numero: '123',
        bairro: 'Centro',
    ...
    },
    {
      ...
      descricao: 'Jovem grupo focado em inovação e designs modernos, mantendo a tradição ancestral.',
      endereco: {
  ...
  produtos: [
    {
      ...
      descricao: 'Linda toalha de mesa em renda de filé com motivos florais típicos do cerrado cearense.',
    ...
    },
    {
      ...
      descricao: 'Elegante caminho de mesa feito em técnica tradicional de renda de filé.',
    ...
    },
    {
      ...
      descricao: 'Blusa feminina delicada com detalhes em renda de filé no decote e mangas.',
  ...
  noticias: [
    {
      ...
      resumo: 'A tradicional feira de artesanato de Jaguaribe registrou recorde de vendas este mês, aquecendo a economia local.',
      categoria: 'novidades',
    ...
    },
    {
      ...
      resumo: 'Jovens artesãs de Jaguaribe se dedicam a aprender e inovar a técnica da renda de filé.',
      categoria: 'cultura',
      dataPublicacao: new Date().toISOString(),
...
async function popularDados() {
  try {
    ...
    console.log('📝 Acesse o Sanity Studio para visualizar: http://localhost:3334');
